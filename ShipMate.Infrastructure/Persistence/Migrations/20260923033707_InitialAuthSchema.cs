        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    has_password = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ...
                    github_id = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    github_username = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ...
                    notification_preference = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    github_access_token = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_github_connections_users_user_id",
                        column: x => x.user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_github_connections_user_id",
